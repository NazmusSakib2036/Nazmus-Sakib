  ...
  <div className="space-y-6">
    ...
    <div className="flex items-center space-x-4">
      ...
      <div>
        ...
        <p className="text-gray-400">
          <a href="mailto:nazmuss024@gmail.com" className="hover:underline">
            nazmuss024@gmail.com
          </a>
        </p>
        <p className="text-gray-400">
          <a href="mailto:sakib_41240102036@nub.ac.bd" className="hover:underline">
            sakib_41240102036@nub.ac.bd
          </a>
        </p>
      </div>
    </div>
    ...
    <div className="flex items-center space-x-4">
      ...
      <div>
        ...
        <p className="text-gray-400">
          <a href="tel:+8801313186576" className="hover:underline">
            +8801313-186576
          </a>
        </p>
      </div>
    ...
    <div className="flex items-center space-x-4">
      ...
      <div>
        ...
        <p className="text-gray-400">Dakshinkhan, Dhaka-1230</p>
      </div>
    </div>
  </div>
</div>
